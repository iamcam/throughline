...
| 15    | Query rewriting ✅ Complete                                  | Vague/pronoun-dependent follow-ups resolve to retrievable queries before search; measurable in Phoenix |
...
1. Decoupled worker queue (streaQ + Redis) — see Phase 12
...
`ARCHITECTURE.md` §7 and `OPERATIONS.md` now both reflect the real compose setup.
